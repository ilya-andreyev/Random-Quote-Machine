...
const colorArray = ['#f2a365', '#222831', '#30475e', '#202040', '#543864', '#ff6363', '#ffbd69', '#54123b', '#84142d', '#c02739', '#29c7ac', '#b030b0', '#ff0000', '#ffd700', '#b55400', '#a7d129', '#000000', '#f6c90e', '#220e24'];
...
const init = ({ quotes }) => {
  const randomQuote = () => {
    ...
    const hrefTwitter = `https://twitter.com/intent/tweet?hashtags=quotes&text="${encodeURIComponent(quote)}" ${encodeURIComponent(author)}`;
    const hrefTumblr = `https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=quotes&caption=${encodeURIComponent(author)}&content=${encodeURIComponent(quote)}&canonicalUrl=https%3A%2F%2Fwww.tumblr.com%2Fbuttons&shareSource=tumblr_share_button`;
